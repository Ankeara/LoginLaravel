                        ...
                        <ul class="list-unstyled list-unstyled-border">
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                    src="{{ url('assets/img/avatar/avatar-1.png') }}" alt="avatar">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                    src="{{ url('assets/img/avatar/avatar-2.png') }}" alt="avatar">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                    src="{{ url('assets/img/avatar/avatar-3.png') }}" alt="avatar">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                    src="{{ url('assets/img/avatar/avatar-4.png') }}" alt="avatar">
                                <div class="media-body">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            <li class="media">
                                ...
                                <img class="mr-3 rounded-circle" width="50"
                                    src="{{ url('assets/img/avatar/avatar-5.png') }}" alt="avatar">
                                <div class="media-body">
